...
[{!isNull player}, {
    ...
    hint parseText format [
        "<t color='%1' align='center'>Bonjour %2</t> <br/>Bienvenue à toi sur le serveur du <t color='%1'>GIE</t> ! <br/>Il y a actuellement %3 joueur(s) connecté(s). Passe un bon moment :) <br/><br/>Afin de communiquer avec nous, nous t'invitons à rejoindre notre <t color='%1'>TS</t>: <br/>ts3.polygames.net <br/>mdp: alphatest <br/><br/>Attention, n'oublie pas qu'ici, chacune de tes action a des conséquences sur la mission :) <br/><br/><t color='%1' align='center'>Le Staff GIE</t>", 
        "#B71C1C", 
        name player, 
