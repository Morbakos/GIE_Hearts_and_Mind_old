class Params {
    ...
    class btc_p_en { // Enemy type:
        ...
        texts[]={"0 - Bohemia Interactive: AAF (Side: GUER)","1 - Bohemia Interactive: CSAT (Side: EAST)","2 - Bohemia Interactive: FIA (Side: EAST)","3 - Bohemia Interactive: FIA (Side: GUER)","4 - Bohemia Interactive: FIA (Side: WEST)","5 - Bohemia Interactive: LDF (Side: GUER)","6 - Bohemia Interactive: OTAN (Side: WEST)","7 - Bohemia Interactive: Pillards (Side: GUER)","8 - Bohemia Interactive: Syndikat (Side: GUER)","9 - Enoch Bohemia Interactive: Spetsnaz (Side: EAST)","10 - Expansion Bohemia Interactive: CSAT (Pacifique) (Side: EAST)","11 - Expansion Bohemia Interactive: CTRG (Side: WEST)","12 - Expansion Bohemia Interactive: Gendarmerie (Side: EAST)","13 - Expansion Bohemia Interactive: Gendarmerie (Side: WEST)","14 - Expansion Bohemia Interactive: OTAN (Pacifique) (Side: WEST)","15 - FRANCE EPURVLAD,KROGAR & AMF: France (Side: WEST)","16 - Mark Blackburne: France faction (Side: WEST)","17 - Mark Bohemia Interactive: OTAN (for̻t) (Side: WEST)","18 - R3F Bohemia Interactive: R3F (Side: WEST)","19 - R3F Team R3F: R3F (Side: EAST)","20 - R3F Team R3F: R3F Missions (Side: EAST)","21 - R3F Team R3F: R3F Missions (Side: GUER)","22 - R3F Team R3F: R3F Missions (Side: WEST)","23 - R3F:  (Side: GUER)","24 - RHS Red Hammer Studios: Russia (VMF) (Side: EAST)","25 - RHS_AFRF Red Hammer Studios: Russia (MSV) (Side: EAST)","26 - RHS_AFRF Red Hammer Studios: Russia (RVA) (Side: EAST)","27 - RHS_AFRF Red Hammer Studios: Russia (TV) (Side: EAST)","28 - RHS_AFRF Red Hammer Studios: Russia (VDV) (Side: EAST)","29 - RHS_AFRF Red Hammer Studios: Russia (VPVO) (Side: EAST)","30 - RHS_AFRF Red Hammer Studios: Russia (VV) (Side: EAST)","31 - RHS_AFRF Red Hammer Studios: Russia (VVS - Camo) (Side: EAST)","32 - RHS_AFRF Red Hammer Studios: Russia (VVS - Grey) (Side: EAST)","33 - RHS_GREF Red Hammer Studios: CDF (Air Forces) (Side: WEST)","34 - RHS_GREF Red Hammer Studios: CDF (Ground Forces) (Side: GUER)","35 - RHS_GREF Red Hammer Studios: CDF (Ground Forces) (Side: WEST)","36 - RHS_GREF Red Hammer Studios: CDF (National Guard) (Side: GUER)","37 - RHS_GREF Red Hammer Studios: CDF (National Guard) (Side: WEST)","38 - RHS_GREF RHS (A2 port): CDF (Air Forces) (Side: GUER)","39 - RHS_SAF Red Hammer Studios: SAF (KOV) (Side: GUER)","40 - RHS_SAF RHS (A2 port): SAF (Casques Bleus) (Side: GUER)","41 - RHS_SAF RHS (A2 port): SAF (KOV) (Side: EAST)","42 - RHS_SAF RHS (A2 port): SAF (RVIPVO) (Side: EAST)","43 - RHS_SAF RHS (A2 port): SAF (RVIPVO) (Side: GUER)","44 - RHS_USAF Red Hammer Studios: USA (Army - D) (Side: WEST)","45 - RHS_USAF Red Hammer Studios: USA (Army - W) (Side: WEST)","46 - RHS_USAF Red Hammer Studios: USA (Navy) (Side: WEST)","47 - RHS_USAF Red Hammer Studios: USA (SOCOM) (Side: WEST)","48 - RHS_USAF Red Hammer Studios: USA (USAF) (Side: WEST)","49 - RHS_USAF Red Hammer Studios: USA (USMC - D) (Side: WEST)","50 - RHS_USAF Red Hammer Studios: USA (USMC - W) (Side: WEST)","51 - RHSGREF Jester2138 for RHS: Horizon Islands Defence Force (Side: WEST)","52 - RHSGREF Red Hammer Studios: CDF (UN) (Side: GUER)","53 - RHSGREF Red Hammer Studios: ChDKZ (Side: EAST)","54 - RHSGREF Red Hammer Studios: ChDKZ (Side: GUER)","55 - RHSGREF Red Hammer Studios: NAPA (Side: GUER)","56 - RHSGREF Red Hammer Studios: Tanoan Liberation Army (Side: EAST)","57 - RHSGREF Red Hammer Studios: Tanoan Liberation Army (Side: GUER)","58 - Team R3F: R3F (Side: GUER)"};
        default = 51;
    };
