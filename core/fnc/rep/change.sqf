...
private _reputationBeforeUpdate = btc_global_reputation;

btc_global_reputation = btc_global_reputation + _reputation;

diag_log format ["[REPUTATION] Old reputation: %1. New reputation: %2. Diff: %3", _reputationBeforeUpdate, btc_global_reputation, _reputation];
