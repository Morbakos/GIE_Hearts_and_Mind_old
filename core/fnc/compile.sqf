...
if (isServer) then {
    ...
    // ZEUS
    gie_zeus_fnc_addZeusToPlayer = compileScript ["core\fnc\zeus\addZeusToPlayer.sqf"];
};
...
gie_fnc_find_nearest_player = compileScript ["core\fnc\common\findNearestPlayer.sqf"];
