...
btc_fnc_find_nearest_player = compile preprocessFileLineNumbers "core\fnc\common\findNearestPlayer.sqf";
...
if (!isDedicated) then {
    ...
    gie_fnc_log_clear_inventory = compile preprocessFileLineNumbers "core\fnc\log\clear_inventory.sqf";
